...
namespace TellMe.Core.Contracts.DataServices
{
    public interface IApiProvider
    {
        ...
        Task<Result<TResult>> SendDataAsync<TResult>(string uri, object data, HttpMethod method, bool anonymously = false);
        Task<Result<TResult>> SendDataAsync<TResult>(string uri, HttpMethod method, HttpContent content, bool anonymously = false, bool refreshExpiredToken = true);
        Task<Result<TResult, TErrorResult>> SendDataAsync<TResult, TErrorResult>(string uri, HttpMethod method, HttpContent content, bool anonymously = false, bool refreshExpiredToken = true);

...
namespace TellMe.DAL.Types.Services
{
    ...
    {
        private readonly IRepository<ApplicationUser, string> _serviceRepository;
        ...
        {
            var result = await _serviceRepository.GetQueryable().SingleAsync(a => a.Id == id).ConfigureAwait(false);
            return result;
        }
